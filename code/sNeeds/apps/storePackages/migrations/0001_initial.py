# Generated by Django 2.2.3 on 2020-03-22 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sold_store_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sold_store_package_phases', to='storePackages.SoldStorePackage')),
            ],
            options={
                'ordering': ['phase_number'],
            },
